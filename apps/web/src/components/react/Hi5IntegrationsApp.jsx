...
export default function Hi5IntegrationsApp() {
  return (
    <Hi5ModuleApp
      ...
      title="Integrations"
      description="Connect AI, PSA, identity, email, storage, and remote session providers."
      ...
      rows={[
        ...
        { title: "API connection preserved", meta: "/api/integrations", icon: Plug, color: "#2563eb", badge: "API", badgeClass: "badge-blue" },
