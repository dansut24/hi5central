...
export default function Hi5SoftwareApp() {
  return (
    <Hi5ModuleApp
      moduleKey="software"
      title="Software"
      description="Software inventory, catalogue, vulnerabilities, and deployments."
      apiUrl="/api/software"
      primaryAction="Add Software"
      metrics={[
      ...
      rows={[
        ...
        { title: "API connection preserved", meta: "/api/software", icon: Plug, color: "#2563eb", badge: "API", badgeClass: "badge-blue" },
