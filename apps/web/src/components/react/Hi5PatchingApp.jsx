...
export default function Hi5PatchingApp() {
  return (
    <Hi5ModuleApp
      moduleKey="patching"
      title="Patching"
      description="Windows updates, third-party patching, approvals, and compliance."
      apiUrl="/api/patching/summary"
      ...
      rows={[
        ...
        { title: "API connection preserved", meta: "/api/patching/summary", icon: Plug, color: "#2563eb", badge: "API", badgeClass: "badge-blue" },
