...
export default function Hi5BrandingApp() {
  return (
    <Hi5ModuleApp
      moduleKey="branding"
      title="Branding"
      description="White-label portal branding, colours, domains, and product identity."
      apiUrl="/api/branding"
      primaryAction="Save Branding"
      metrics={[
      ...
      rows={[
        ...
        { title: "API connection preserved", meta: "/api/branding", icon: Plug, color: "#2563eb", badge: "API", badgeClass: "badge-blue" },
