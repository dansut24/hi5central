...
export default function Hi5UsersApp() {
  return (
    <Hi5ModuleApp
      moduleKey="users"
      title="Users"
      description="Manage users, roles, groups, access, and tenant membership."
      apiUrl="/api/users"
      ...
      rows={[
        ...
        { title: "API connection preserved", meta: "/api/users", icon: Plug, color: "#2563eb", badge: "API", badgeClass: "badge-blue" },
