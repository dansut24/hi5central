...
export default function Hi5TicketsApp() {
  return (
    <Hi5ModuleApp
      moduleKey="tickets"
      title="Tickets"
      description="Incidents, requests, queues, and SLA tracking."
      apiUrl="/api/tickets"
      ...
      rows={[
        ...
        { title: "API connection preserved", meta: "/api/tickets", icon: Plug, color: "#2563eb", badge: "API", badgeClass: "badge-blue" },
