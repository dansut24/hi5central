...
export default function Hi5AISettingsApp() {
  return (
    <Hi5ModuleApp
      moduleKey="ai"
      title="AI Settings"
      description="Configure tenant AI providers, keys, safety controls, and usage policies."
      apiUrl="/api/ai/settings"
      ...
      rows={[
        ...
        { title: "API connection preserved", meta: "/api/ai/settings", icon: Plug, color: "#2563eb", badge: "API", badgeClass: "badge-blue" },
